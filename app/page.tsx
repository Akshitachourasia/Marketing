...
export default function Home() {
  ...
  return (
    <div className="w-full md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
      <Navbar
        websiteDesign={scrollToWebsiteDesign}
        graphicDesign={scrollToGraphicDesign}
        shopifyStores={scrollToShopifyStores}
        brands={scrollToBrands}
      ...
      <div className="p-4 mx-auto relative z-10 w-full pt-10 md:pt-20 px-2">
        ...
        <div id="website-design" ref={websiteDesignRef}>
          <WebsiteDesign />
        </div>
        <div id="graphic-design" ref={graphicDesignRef}>
          <GraphicDesign />
        </div>
        <div id="shopify-stores" ref={shopifyStoresRef}>
          <ShopifyStores />
        </div>
